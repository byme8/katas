...
namespace Pagination.Migrations
{
    ...
    [Migration("20250610225946_OptimizeIndexesForSoftDeleteQueries")]
    partial class OptimizeIndexesForSoftDeleteQueries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pagination.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasIndex("IsDeleted", "UserId", "CreatedAt")
                        .HasDatabaseName("IX_Comments_IsDeleted_UserId_CreatedAt");
