...
{
    /// <inheritdoc />
    public partial class OptimizeIndexesForSoftDeleteQueries : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_IsDeleted_CreatedAt_Id",
                table: "Comments",
                columns: new[] { "IsDeleted", "CreatedAt", "Id" });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_IsDeleted_UpdatedAt_Id",
                table: "Comments",
                columns: new[] { "IsDeleted", "UpdatedAt", "Id" });
